...
const PERSONAL: Project[] = [
  { title: "FinancialMCP", blurb: "Open-source MCP server giving any AI agent 24 stock market intelligence tools. Covers composite scoring, SEC EDGAR filings, insider trades, Treasury yields, CFTC positioning, Google Trends sentiment, and market regime detection. All from free public data sources with no API keys required.", impact: "Published on PyPI; enables any MCP-compatible AI agent to perform professional-grade financial analysis.", tech: ["Python","MCP","yfinance","SEC EDGAR","CFTC","Treasury.gov","Google Trends"], code: "https://github.com/arnavbhatia1/FinancialMCP", demo: "https://pypi.org/project/financial-mcp-server/" },
  { title: "MarketPulse", blurb: "Sentiment intelligence for financial markets. Ingests posts from Reddit, Stocktwits, and news APIs, applies weak supervision with 16 labeling functions, trains a sentiment classifier, extracts ticker entities, and visualizes per-ticker sentiment through an interactive Streamlit dashboard.", impact: "End-to-end ML pipeline from ingestion to interactive analytics.", tech: ["Python","scikit-learn","Streamlit","Plotly","PRAW","pandas"], code: "https://github.com/arnavbhatia1/MarketPulse" },
  ...
  { title: "RecipeFinder", blurb: "Web app enabling users to discover recipes based on available ingredients via the Spoonacular API. Features include favorites management, community reviews with star ratings, dark mode, and local persistence.", impact: "Ingredient-driven recipe discovery with community engagement.", tech: ["React","JavaScript","Axios","CSS3","Spoonacular API"], code: "https://github.com/arnavbhatia1/RecipeFinder" },
];
