...
const Btn = ({ href, children }: { href: string; children: React.ReactNode }) => (
  <a
    ...
    className="inline-flex items-center gap-2 rounded-full border border-foreground/20 bg-background px-4 py-2 font-semibold shadow-sm transition hover:bg-foreground/5"
  >
    {children}
  </a>
);
  ...
  return (
    <main className="grid min-h-screen place-items-center px-6">
      <section className="max-w-3xl text-center">
        ...
        <p className="mx-auto mb-5 max-w-2xl text-lg leading-relaxed text-foreground/80">
