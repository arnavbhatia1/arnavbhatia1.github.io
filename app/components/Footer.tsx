      ...
      <div className="mx-auto max-w-5xl px-5 py-10">
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/experience" className="text-foreground/70 hover:text-foreground hover:underline">
                  Experience
                </Link>
              </li>
              <li>
                <Link href="/projects" className="text-foreground/70 hover:text-foreground hover:underline">
                  Projects
                </Link>
              </li>
              <li>
                <Link href="/certifications" className="text-foreground/70 hover:text-foreground hover:underline">
                  Certifications
                </Link>
              </li>
              <li>
        ...
        <div className="mt-10 flex flex-col items-center justify-between gap-4 border-t border-foreground/10 pt-8 sm:flex-row">
          <p className="text-sm text-foreground/60">
            © {currentYear} Arnav Bhatia. All rights reserved.
          </p>
