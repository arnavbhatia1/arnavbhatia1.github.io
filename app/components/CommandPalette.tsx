...
export default function CommandPalette() {
  ...
  const commands = useMemo<Command[]>(
    () => [
      ...
      { id: "dl", label: "Download resume (PDF)", group: "Actions", hint: "PDF", keywords: "cv pdf download", run: () => external("/Arnav_Bhatia_Resume.pdf") },
      ...
      { id: "theme", label: "Toggle dark / light theme", group: "Actions", hint: "Theme", keywords: "dark light mode appearance", run: toggleTheme },
    ],
    [go, external, toggleTheme]
  );
